...
SYSTEM1_feat_list = [
    {'dir':'../../../FULL_data/0','test_sem':9,'num_crs':1341,'user_feat':[8,365],'item_feat':[67, 4, 27, 5]},
    {'dir':'../../../FULL_data/1','test_sem':9,'num_crs':570 ,'user_feat':[8,365],'item_feat':[79, 5, 20, 1]},
    {'dir':'../../../FULL_data/2','test_sem':9,'num_crs':2173,'user_feat':[8,365],'item_feat':[66, 12, 49, 9]},
    {'dir':'../../../FULL_data/3','test_sem':9,'num_crs':879 ,'user_feat':[8,365],'item_feat':[68, 4, 19, 1]},
    {'dir':'../../../FULL_data/4','test_sem':9,'num_crs':1636,'user_feat':[8,365],'item_feat':[69, 3, 30, 7]},
    {'dir':'../../../FULL_data/5','test_sem':9,'num_crs':3437,'user_feat':[8,365],'item_feat':[77, 5, 44, 11]},
    {'dir':'../../../FULL_data/6','test_sem':9,'num_crs':419 ,'user_feat':[8,365],'item_feat':[59, 9, 13, 2]},
    {'dir':'../../../FULL_data/7','test_sem':9,'num_crs':3538,'user_feat':[8,365],'item_feat':[105, 14, 39, 8]},
    {'dir':'../../../FULL_data/8','test_sem':9,'num_crs':1281,'user_feat':[8,365],'item_feat':[67, 6, 27, 3]},
    {'dir':'../../../FULL_data/9','test_sem':6,'num_crs':769 ,'user_feat':[8,365],'item_feat':[69, 7, 17, 2]},
    {'dir':'../../../FULL_data/10','test_sem':6,'num_crs':769 ,'user_feat':[8,365],'item_feat':[71, 5, 16, 3]},
    {'dir':'../../../FULL_data/11','test_sem':9,'num_crs':1717,'user_feat':[8,365],'item_feat':[85, 9, 36, 7]},
    {'dir':'../../../FULL_data/12','test_sem':9,'num_crs':678 ,'user_feat':[8,365],'item_feat':[52, 9, 25, 8]},
    {'dir':'../../../FULL_data/13','test_sem':6,'num_crs':98  ,'user_feat':[8,365],'item_feat':[24, 5, 2, 1]},
    {'dir':'../../../FULL_data/14','test_sem':9,'num_crs':1177,'user_feat':[8,365],'item_feat':[73, 5, 33, 5]},
    {'dir':'../../../FULL_data/15','test_sem':9,'num_crs':774 ,'user_feat':[8,365],'item_feat':[55, 6, 20, 1]},
    {'dir':'../../../FULL_data/16','test_sem':9,'num_crs':2355,'user_feat':[8,365],'item_feat':[81, 7, 53, 8]},
    {'dir':'../../../FULL_data/17','test_sem':9,'num_crs':332 ,'user_feat':[8,365],'item_feat':[52, 4, 21, 1]},
    {'dir':'../../../FULL_data/18','test_sem':9,'num_crs':1190,'user_feat':[8,365],'item_feat':[68, 9, 21, 6]},
]
...
model_config = {
    ...
    'num_stu_feat_list' : [
        [True, basic_config['stu_features'][0], 'StudentsDegree'],
        [True, basic_config['stu_features'][1], 'StudentsMajor'],
    ],
    'num_crs_feat_list' : [
        [True, basic_config['crs_features'][0], 'CoursesSubjects'],
        [True, basic_config['crs_features'][1], 'CoursesComponents'],
        [True, basic_config['crs_features'][2], 'CoursesDepartment'],
        [True, basic_config['crs_features'][3], 'CoursesSchool'],
    ],
...
train_generator_config = {
    ...
    'use_sampling' : True, # Sample a number or precentage of courses as input.
    'sampling_level' : 'course',
    'sampling_num_rate' : [10],
    'sampling_window' : [0, basic_config['num_sem']],
    'use_history' : True, # Use first several semester as input.
    'history_num' : [0, 3], # ('random', 0, [0,3,6,9])
    'num_times' : 0,
    'predict_future' : False, 
    'batch_size' : basic_config['batch_size'],
    'shuffle' : True,
...
import json
save_name = './results/BERTriu-{0}-{1}.json'.format(SYSTEM1_num, iter_num)
