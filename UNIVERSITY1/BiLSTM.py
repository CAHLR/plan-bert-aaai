...
from util.Datahelper import UNIVERSITY1_load_data, HOSTOS_load_data, list_partition, list_sampling, list_padding, mat_partition, mat_sampling, mat_padding, set_top_n, list2mat
...
'''
model.load_weights('./checkpoint/BiLSTM-10.h5')
